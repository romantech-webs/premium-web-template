        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/60 text-xl mb-12 leading-relaxed">
              Combinamos experiencia, tecnología de vanguardia y un trato
              personalizado para que alcances tus objetivos.
            </p>
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              {[
                { value: "8", label: "Especialidades", icon: "Layers" },
                { value: `+${clinic.reviews.count}`, label: "Pacientes tratados", icon: "Users" },
